...
MOC = moc
CXXSOURCES = main.cpp LicenseUtilities.cpp PathUtilities.cpp Convert2Shape.cpp \
	Convert2GDB.cpp CreateTopologyGDB.cpp CreateGDB.cpp LoadLayer.cpp
CXXOBJECTS = $(CXXSOURCES:.cpp=.o) $(MOC_SOURCES:.cpp=.o)
CXXFLAGS = -DESRI_UNIX $(INCLUDEDIRS) -g
CXX = g++
